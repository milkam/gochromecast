...
try:
	...
	print "socket closed"
@balloob
balloob commented on Aug 18, 2014
I would like to add your code to my Python module PyChromecast which is released under the MIT license. Would that be okay? I will make sure you will be attributed for the code.
